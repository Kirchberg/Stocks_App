...
public extension SkeletonTableViewDataSource {
    func collectionSkeletonView(_ skeletonView: UITableView, numberOfRowsInSection _: Int) -> Int {
        return skeletonView.estimatedNumberOfRows
    }

    func numSections(in _: UITableView) -> Int { return 1 }
...
public extension SkeletonTableViewDelegate {
    func collectionSkeletonView(_: UITableView, identifierForHeaderInSection _: Int) -> ReusableHeaderFooterIdentifier? {
        return nil
    }

    func collectionSkeletonView(_: UITableView, identifierForFooterInSection _: Int) -> ReusableHeaderFooterIdentifier? {
        return nil
    }
}
